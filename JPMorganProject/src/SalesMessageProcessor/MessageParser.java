...
public class MessageParser {
    ...
    // Just to handle the single cases of the fruit products
    // Made under the assumption that no other sale items will be given. e.g Oranges, Pears. etc.
    // @return[String] parsed string e.g 'mango' will become 'mangos'
